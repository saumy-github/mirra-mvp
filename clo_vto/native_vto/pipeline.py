...
def run_pipeline(
    ...
    print("=" * 64)
    print(f"Native avatar: {ctx.avatar_path}")
    ...
    if overall_ok:
        print("Native-avatar pipeline complete.")
    else:
        print("Native-avatar pipeline ended before completion due to a failed gate/step.")

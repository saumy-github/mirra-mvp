  ...
  return (
    ...
    >
      ...
      <div className={styles.successActions}>
        {/* Business accounts keep the email/password flow; the shopper side at
            /auth/login is Google-only. See router.tsx. */}
        <Link to="/business/sign-up" className={styles.primaryLink}>
      ...
      <p className={styles.deliveryNote}>
        Already have a Mirra workspace? <Link to="/business/login">Log in</Link>
      </p>
    </motion.section>
  );
}

...
/**
 * Business sign-up — the email/password flow the shopper side no longer
 * exposes. Reached from the Join page after a brand submits its application.
 */
    ...
    <AuthShell>
      ...
      <form onSubmit={onSubmit} className="auth-form" noValidate>
        ...
        <div className="auth-consent flex items-start gap-3 rounded-[14px] px-1 py-1 text-xs leading-relaxed text-muted">
          <input
            aria-labelledby="business-signup-consent-copy"
            type="checkbox"
            checked={accepted}
            onChange={(e) => setAccepted(e.target.checked)}
            className="mt-0.5 size-4.5 shrink-0 accent-blue"
          />
          <span id="business-signup-consent-copy">
            I accept the{" "}
